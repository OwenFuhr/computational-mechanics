...
plt.plot(t[0:-1:5], vx, 'r-', label='x-velocity')
plt.plot(t[0:-1:5],vy, 'b-', label='y-velocity')
plt.legend();
```
...
currsign = 0
prevsign = 0
#Slice the data and find the coefficients of restitution.
