...
A_consts = np.array([[L**3/6, L**2/2],
                    [L**2/2, L]])
b_consts = np.array([q*L**4/24, q*L**3/6])
...
for dx in dxes:
    ...
    ohm = q*x**4/24 + ConstsAB[0]*x**3/6 + ConstsAB[1]*x**2/2
    #4th Derivative for matrix
    d4ohm = (ohm[4:]-4*ohm[3:-1]+6*ohm[2:-2]-4*ohm[1:-3]+ohm[:-4])/dx**4
