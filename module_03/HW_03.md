...
```{code-cell} ipython3
print(num_sol_drag_Lax)
#print('''The tennis ball hits the ground at {:.2f} s
#The lacrosse ball hits the ground at {:.2f}'''.format(num_sol_drag[-1,0],num_sol_drag_Lax[-1,0]))
```
...
for j, dt in enumerate(dt_values):
    ...
    num_sol_time_rk2[j] = num_sol_time_rk2.copy()
...
for j, dt in enumerate(dt_values):
    ...
    #initialize solution array
    num_sol_time_heun = np.zeros([N,2])
    ...
    num_sol_time_heun[j] = num_sol_time_heun.copy()
