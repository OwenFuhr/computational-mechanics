...
def montecarlo_buckle(E,r_mean,r_std,L,N=100):
    ...
    '''
    r = np.array([r_mean,r_std])
    P_cr = (np.pi**3*E*r)/(16*L**2)
    mean_buckle_load = P_cr[0]
    std_buckle_load = P_cr[1]
...
#Rod info (mm)
rmean = 0.01*1000
tolerance = 0.001*1000
rstd = tolerance

#Part a

MBL, SBL = montecarlo_buckle(0.2,rmean,rstd,5*1000)

print("The mean buckle load, std buckle load ")
```
