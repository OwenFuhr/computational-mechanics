...
MBL, SBL = montecarlo_buckle(200000000000,rmean,rstd,5)

print("The mean buckle load is {:0.2f} N, and the standard deviation buckle load is {:0.2f} N".format(MBL,SBL))
```
