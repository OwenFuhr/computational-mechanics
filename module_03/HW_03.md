...
plt.plot(t[0:-1], vx, 'r-', label='$v_x$')
plt.plot(t, x_fit(t), 'b--', linewidth=1.5, label='$v_x$ fit')

plt.plot(t[0:-1],vy, 'b-', label='$v_y$')
plt.plot(t, y_fit(t), 'r--', linewidth=1.5, label='$v_y$ fit')
plt.title('Velocity vs. time')
plt.xlabel('Time (s)')
plt.ylabel('Velocity (m/s)')
plt.legend();
...
#Second order Polyfit for x and y
...
plt.plot(t, x_fit, 'b--', linewidth=1.5, label='X fit')
...
plt.plot(t, y_fit, 'r--', linewidth=1.5, label='Y fit')
plt.title('X, Y Position vs. Time')
plt.xlabel('Time (s)')
plt.ylabel('Position (m)')
plt.legend();
