...
#Plotting cleaned
plt.figure(1)
plt.scatter(beers_cleaned["ibu"],beers_cleaned["abv"])
plt.xlabel("IBU")
plt.ylabel("ABV")
plt.title("Beer ABV vs. IBU - Cleaned out NaN")

#Plotting filled
plt.figure(2)
plt.scatter(beers_filled["ibu"],beers_filled["abv"])
plt.xlabel("IBU")
plt.ylabel("ABV")
plt.title("Beer ABV vs. IBU - NaN filled with 0")
```
...
plt.plot(year1, EU_fit1(years1), "k--",label="Europe Fit 1965-1995", linewidth=1.5)
...
popt,pcov = curve_fit(func, xi, TC)

print(popt)
plt.figure(1, figsize=(8,5))
plt.plot(xi, np.log(TC),'bo')

plt.plot(xi, func(xi,*popt))
plt.xlabel("Year")
plt.ylabel("MOS Transistor Count (log scale)")
plt.title("Semilog y-axis Plot of MOS Transistor Count vs. Year")
```
